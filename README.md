...
Soumettez `EVALS.md` à l'agent avec le prompt suivant :
...
- **1.0.0** → **2.0.0** : Changements incompatibles
...
- [ ] `EVALS.md` avec 5+ évaluations couvrant cas nominaux et cas d'erreur
